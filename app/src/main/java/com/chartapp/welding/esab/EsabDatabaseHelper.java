package com.chartapp.welding.esab;
...
public class EsabDatabaseHelper extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "welding.db";
    private static final int DATABASE_VERSION = 1;
    Context context;


    public EsabDatabaseHelper(Context context) {
    ...
    public ArrayList<Data> getAllData(){
        try {
            ...
            if(sqLiteDatabase != null){
                Cursor cursor = sqLiteDatabase.rawQuery("select * from esab",null);
