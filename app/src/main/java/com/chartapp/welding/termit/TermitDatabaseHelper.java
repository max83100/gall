package com.chartapp.welding.termit;
...
public class TermitDatabaseHelper extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "welding.db";
    private static final int DATABASE_VERSION = 1;
    Context context;


    public TermitDatabaseHelper(Context context) {
    ...
    public ArrayList<Data> getAllData(){
        try {
            ...
            if(sqLiteDatabase != null){
                Cursor cursor = sqLiteDatabase.rawQuery("select * from termit",null);
