package com.chartapp.phones.lg;
...
public class LgDatabaseHelper extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "BookLibrary.db";
    private static final int DATABASE_VERSION = 1;
    Context context;


    public LgDatabaseHelper(Context context) {
    ...
    public ArrayList<Data> getAllData(){
        try {
            ...
            if(sqLiteDatabase != null){
                Cursor cursor = sqLiteDatabase.rawQuery("select * from lg",null);
