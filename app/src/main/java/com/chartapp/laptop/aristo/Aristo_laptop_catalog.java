package com.chartapp.laptop.aristo;
...
import com.chartapp.laptop.apple.AppleLaptopHelper;
import com.chartapp.phones.Adapter;
import com.chartapp.phones.Data;

import java.util.ArrayList;

public class Aristo_laptop_catalog extends AppCompatActivity {

    AristoLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new AristoLaptopHelper(this);
        list = new ArrayList<>();
