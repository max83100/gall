package com.chartapp.laptop.gateway;
...
public class Gateway_laptop_catalog extends AppCompatActivity {

    GatewayLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new GatewayLaptopHelper(this);
        list = new ArrayList<>();
