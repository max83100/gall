package com.chartapp.laptop.samsung;
...
public class Samsung_laptop_catalog extends AppCompatActivity {

    SamsungLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new SamsungLaptopHelper(this);
        list = new ArrayList<>();
