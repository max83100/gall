package com.chartapp.laptop.fujitsu;
...
public class Fujitsu_laptop_catalog extends AppCompatActivity {

    FujitsuLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new FujitsuLaptopHelper(this);
        list = new ArrayList<>();
