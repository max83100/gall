package com.chartapp.laptop.apple;
...
import com.chartapp.laptop.asus.AsusLaptopHelper;
import com.chartapp.phones.Adapter;
import com.chartapp.phones.Data;

import java.util.ArrayList;

public class Apple_laptop_catalog extends AppCompatActivity {

    AppleLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new AppleLaptopHelper(this);
        list = new ArrayList<>();
