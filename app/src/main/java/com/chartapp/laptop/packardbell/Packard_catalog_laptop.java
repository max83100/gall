package com.chartapp.laptop.packardbell;
...
public class Packard_catalog_laptop extends AppCompatActivity {
    PackardLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new PackardLaptopHelper(this);
        list = new ArrayList<>();
