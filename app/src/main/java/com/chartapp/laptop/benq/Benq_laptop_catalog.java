package com.chartapp.laptop.benq;
...
import com.chartapp.laptop.aristo.AristoLaptopHelper;
import com.chartapp.phones.Adapter;
import com.chartapp.phones.Data;

import java.util.ArrayList;

public class Benq_laptop_catalog extends AppCompatActivity {
    BenqLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new BenqLaptopHelper(this);
        list = new ArrayList<>();
