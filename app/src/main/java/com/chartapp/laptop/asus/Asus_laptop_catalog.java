package com.chartapp.laptop.asus;
...
import com.chartapp.laptop.acer.AcerLaptopHelper;
import com.chartapp.phones.Adapter;
import com.chartapp.phones.Data;

import java.util.ArrayList;

public class Asus_laptop_catalog extends AppCompatActivity {
    AsusLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new AsusLaptopHelper(this);
        list = new ArrayList<>();
