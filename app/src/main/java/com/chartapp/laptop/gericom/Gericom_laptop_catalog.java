package com.chartapp.laptop.gericom;
...
public class Gericom_laptop_catalog extends AppCompatActivity {

    GericomLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new GericomLaptopHelper(this);
        list = new ArrayList<>();
