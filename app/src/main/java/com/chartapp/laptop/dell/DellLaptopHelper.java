...
public class DellLaptopHelper extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "laptop.db";
    private static final int DATABASE_VERSION = 1;
    Context context;


    public DellLaptopHelper(Context context) {
    ...
    public ArrayList<Data> getAllData(){
        try {
            ...
            if(sqLiteDatabase != null){
                Cursor cursor = sqLiteDatabase.rawQuery("select * from dell",null);
