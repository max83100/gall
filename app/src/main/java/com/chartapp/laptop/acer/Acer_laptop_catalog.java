package com.chartapp.laptop.acer;
...
import com.chartapp.laptop.compal.CompalLaptopHelper;
import com.chartapp.phones.Adapter;
import com.chartapp.phones.Data;

import java.util.ArrayList;

public class Acer_laptop_catalog extends AppCompatActivity {
    AcerLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new AcerLaptopHelper(this);
        list = new ArrayList<>();
