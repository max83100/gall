package com.chartapp.laptop.roverbook;
...
import com.chartapp.laptop.benq.BenqLaptopHelper;
import com.chartapp.phones.Adapter;
import com.chartapp.phones.Data;

import java.util.ArrayList;

public class Roverbook_laptop_catalog extends AppCompatActivity {

    RoverbookLaptopHelper myDB;
    ArrayList<Data> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new RoverbookLaptopHelper(this);
        list = new ArrayList<>();
