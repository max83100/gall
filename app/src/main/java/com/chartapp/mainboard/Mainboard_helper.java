...
public class Mainboard_helper extends SQLiteAssetHelper {

    static String tab_name;
    private static final String DATABASE_NAME = "motherboard.db";
    private static final int DATABASE_VERSION = 1;
    Context context;



    public Mainboard_helper(Context context) {
    ...
    public ArrayList<Data> getAllData(){
        try {
            ...
            if(sqLiteDatabase != null){
                ...
                //Toast.makeText(context.getApplicationContext(), ""+tab_name, Toast.LENGTH_SHORT).show();
